...
class App {
  ...
  _newWorkout(e) {
    ...
    // If cylcing, create cycling object
    if (type === 'cycling') {
      // Check is data is valid
  ...
  _setLocalStorage() {
    // Only use localStorage for small applications!
    // Objects coming from local storage will not inherit all the methods that they did before.
